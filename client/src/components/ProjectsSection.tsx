...
type ProjectFilter = "all" | "android" | "fullstack" | "ui";
...
const projectFilters: ProjectFilter[] = ["all", "android", "fullstack", "ui"];
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground/70 mt-4 max-w-2xl mx-auto">
              Selected work I owned end-to-end, spanning full-stack features,
              Android builds, and UI design with live demos where available.
            </p>
          </div>
